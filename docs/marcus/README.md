...
| Semana 3 — 21/09 | [#47](https://github.com/rlampago22/RP-IV/issues/47) | Implementada na branch: SEQ-UC02, T04 dinâmica e auditoria | Abrir PR `marcus` → `desenvolvimento` |
